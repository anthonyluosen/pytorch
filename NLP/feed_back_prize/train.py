...
from utilities import EarlyStopping, prepare_training_data, target_id_map
...
def parse_args():
    ...
    parser.add_argument("--input", type=str, default="D://database//feedback//", required=False)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv(os.path.join(args.input, "train_fold.csv"))
